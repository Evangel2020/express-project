...
//     const fileData = fs.createWriteStream(path.join(__dirname, 'public', 'result.txt'));
...
const filePath = path.join(__dirname, 'public', 'laptop-os.md'); 
